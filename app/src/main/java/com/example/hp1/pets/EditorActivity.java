...
public class EditorActivity extends AppCompatActivity {
    ...
    public  void insertdummy(){
       ...
       // long newrow=db.insert(pets.TABLE_NAME, null, values);
        ...
        Log.v("Catalog Activity", "ERROR inserting in " + uri);

        Toast.makeText(EditorActivity.this, "Pet Saved", Toast.LENGTH_SHORT).show();
        if(uri!=null) {
           // Toast.makeText(EditorActivity.this, "New row form in" + uri, Toast.LENGTH_SHORT).show();
        }
        else
        {

            Toast.makeText(EditorActivity.this, "Error adding row", Toast.LENGTH_SHORT).show();
        }
